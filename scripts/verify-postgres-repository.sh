...
printf 'POSTGRES_PUSH_DEVICE_REGISTRY_INTEGRATION=PASS\n'
printf 'POSTGRES_NOTIFICATION_OUTBOX_INTEGRATION=PASS\n'
printf 'POSTGRES_CONVERSATION_SAFETY_INTEGRATION=PASS\n'
